            ...
            <div class="advancedSimPar">
                ...
                <Collapse additionalStyle=true>
                    <div v-show="showAdvanced" class="container">
                        ...
                        <div class="par">
                            <label for="stepSize">Minimum step size: </label><input @change="update" type="number" name="stepSize" :value="this.simPar.simSettings.hmin" step="0.0000001"/>
                        </div>
                        <div class="par">
                            <label for="dataFreq">Graph resolution scale: </label><input @change="update" type="number" name="dataFreq" :value="this.simPar.simSettings.dataFrequencyRatio" step=".1"/>
                        </div>
                        <div class="par">
                            <label for="GraphFreq">Graph update frequency: </label><input @change="update" type="number" name="graphFrequency" :value="this.simPar.simSettings.graphFrequency" step=".1"/>
                        </div>
                        <div class="par">
                            <label for="Glycemia">Glycemia interval: </label>
                            <div class="GlycemiaInterval">
                                [<input @change="intervalChange" name="lower" type="number" min="0" :value="GlycemiaInterval.lower"/>:<input @change="intervalChange" name="upper" type="number" min="0" :value="GlycemiaInterval.upper"/>]
                            </div>
                        </div>
                        <div class="par">
                            <label for="processNoise_GH">Process noise std: </label><input @change="update" type="number" name="processNoise_GH" :value="this.simPar.simSettings.processNoise_GH" step="0.1"/>
                        </div>
                        <div class="par">
                            <label for="HbA1c_interval">HbA1c interval: </label><input @change="update" type="number" name="HbA1c_interval" :value="this.simPar.simSettings.HbA1c_interval" step="0.1"/>
                        </div>
                        <div class="ClosedLoop">
                            ...
                            <div class="par">
                                <label for="clStartTime" class="tooltip" style="position: relative;">First function call at: <span class="tooltiptext" style="width:200px; right: -40%; top: 20px;">The user defined function will first be called at specified time in minutes</span></label><input @change="update" type="number" name="clStartTime" :value="this.simPar.simSettings.clStartTime" step="1" />
                            </div>
                            <div class="par">
                                <label for="clPeriod" class="tooltip" style="position: relative;">Function call period: <span class="tooltiptext" style="width:200px; right: -40%; top: 20px;">The user defined function will be called every specified amount of minutes</span></label><input @change="update" type="number" name="clPeriod" :value="this.simPar.simSettings.clPeriod" step="1" />
                            </div>
                            <div class="function">
                                <label for="closedLoopInit" class="tooltip" style="position: relative;">Initial function: 
                                    <span class="tooltiptext" style="width:200px; right: -75%; top: 20px;">The following code will be called at start of simulation. initialise variable 'memory' to desired structure and values</span>
                                </label>
                                <textarea @change="update" type="text" name="closedLoopInit" class="CLInit" :value="this.simPar.simSettings.clInitStr" ></textarea>
                            </div>
                            <div class="function">
                                <label for="closedLoop" class="tooltip" style="position: relative;">
                                    Function (): 
                                    <span class="tooltiptext" style="width:200px; right: -75%; top: 20px;">The following code will be called at 7am every day. Access current state x['state'] and set variable 'lai' to set the selected long acting insulin's dose, or set variable 'fai' to set the selected fast acting insulin's dose</span>
                                </label>
                                <textarea @change="update" type="text" name="closedLoop" :value="this.simPar.simSettings.clStr" ></textarea>
                            </div>
                        </div>
                    </div>
                </Collapse>
